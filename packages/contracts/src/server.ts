...
/**
 * A palette the environment's machine publishes for T2 Code to follow, read
 ...
 * over as a coherent T2 Code palette instead of a foreign one.
 */
...
export const ServerSelfUpdateInput = Schema.Struct({
  /** Exact npm version of the `@t2code/cli` package to install (never a dist-tag, so
