 ...
 * machine into a T2 Code browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** T2 Code profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give T2 Code Full Disk Access in System Settings → Privacy & Security, then retry.",
