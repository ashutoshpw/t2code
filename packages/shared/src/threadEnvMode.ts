import type { ThreadEnvMode } from "@t2code/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in t2.json > global server setting.
 *
 ...
 * source that outranks t2.json decided, or the file read settled. While
