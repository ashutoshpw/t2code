...
describe("upgradeLegacyContextMessage", () => {
  ...
  it.each([
    ...
    for (const suffix of ["", `\n${review}`]) {
      ...
      expect(result.text).toContain(
        "Before [f.ts line](t2-context://v1/review-comment/legacy_review-comment_1) after",
      );
    }
  });
  ...
  it.each([3, 4, 6])("preserves closing review tags inside a %i-backtick fence", (length) => {
    ...
    expect(result.text).toBe(
      "Before [f.ts line](t2-context://v1/review-comment/legacy_review-comment_1) between [f.ts line](t2-context://v1/review-comment/legacy_review-comment_2) after",
    );
  ...
  it.each([
    ...
    expect(upgraded.text).toBe(
      `${prompt}\n\n[Build line 7](t2-context://v1/terminal/legacy_terminal_1)`,
    );
  });
  ...
  it.each([".", ",", ":", ";", "!", "?", ")", "@", ". Next sentence", "@ next", ".)"])(
    ...
    (suffix) => {
      ...
      expect(result.text).toBe(
        `See [Build line 7](t2-context://v1/terminal/legacy_terminal_1)${suffix}`,
      );
      expect(result.records).toHaveLength(1);
    },
  );
  ...
  it("preserves literal review tokens even beside real review blocks", () => {
    ...
    expect(upgraded.text).toBe(
      "Literal \uE0000\uE000 before [f.ts line](t2-context://v1/review-comment/legacy_review-comment_1) after \uE0007\uE000",
    );
  ...
  it("matches complete terminal line ranges rather than numeric prefixes", () => {
    ...
    expect(upgraded.text).toBe(
      "Compare [Terminal line 10](t2-context://v1/terminal/legacy_terminal_2) and [Terminal lines 1-2](t2-context://v1/terminal/legacy_terminal_3) with [Terminal line 1](t2-context://v1/terminal/legacy_terminal_1)",
    );
  });
  ...
  it("binds U+FFFC placeholders to trailing terminal entries in order", () => {
    ...
    expect(upgraded.text).toBe(
      "Look at [Terminal 1 lines 509-510](t2-context://v1/terminal/legacy_terminal_1) and [Build line 7](t2-context://v1/terminal/legacy_terminal_2) please",
    );
  ...
  it("appends references for terminal entries without placeholders and drops extra placeholders", () => {
    ...
    expect(upgradeLegacyContextMessage(text).text).toBe(
      "[T line 1](t2-context://v1/terminal/legacy_terminal_1) and",
    );
    const noPlaceholder = "hi\n\n<terminal_context>\n- T line 1:\n  1 | x\n</terminal_context>";
    expect(upgradeLegacyContextMessage(noPlaceholder).text).toBe(
      "hi\n\n[T line 1](t2-context://v1/terminal/legacy_terminal_1)",
    );
  });
  ...
  it("binds materialized inline terminal labels from sent messages in place", () => {
    ...
    expect(upgradeLegacyContextMessage(text).text).toBe(
      "Look at [Terminal 1 lines 509-510](t2-context://v1/terminal/legacy_terminal_1) and again [Build line 7](t2-context://v1/terminal/legacy_terminal_2) please",
    );
  });
  ...
  it("upgrades a trailing element block into element records", () => {
    ...
    const upgraded = upgradeLegacyContextMessage(text);
    expect(upgraded.text).toBe("fix this\n\n[<Button>](t2-context://v1/element/legacy_element_1)");
    expect(upgraded.records).toEqual([
      {
        version: 1,
  ...
  it("upgrades trailing preview annotation blocks", () => {
    ...
    const upgraded = upgradeLegacyContextMessage(text);
    expect(upgraded.text).toBe(
      "bigger\n\n[Checkout](t2-context://v1/preview-annotation/legacy_preview-annotation_1)",
    );
    expect(upgraded.records).toEqual([
      {
        version: 1,
  ...
  it("keeps adjacent preview annotations separate and in their original order", () => {
    ...
    expect(upgraded.text).toBe(
      "Compare\n\n[First](t2-context://v1/preview-annotation/legacy_preview-annotation_1) [Second](t2-context://v1/preview-annotation/legacy_preview-annotation_2)",
    );
  ...
  it("replaces inline review comments in place and neutralizes forged closers", () => {
    ...
    const upgraded = upgradeLegacyContextMessage(text);
    expect(upgraded.text).toBe(
      "Before\n[b.ts L4-L6](t2-context://v1/review-comment/legacy_review-comment_1)\nAfter",
    );
    expect(upgraded.records).toEqual([
      {
        version: 1,
  ...
  it("appends trailing review blocks after the other trailing blocks", () => {
    ...
    const upgraded = upgradeLegacyContextMessage(text);
    expect(upgraded.text).toBe(
      "prose\n\n[T line 1](t2-context://v1/terminal/legacy_terminal_1) [f.ts line](t2-context://v1/review-comment/legacy_review-comment_1) [g.ts line](t2-context://v1/review-comment/legacy_review-comment_2)",
    );
  ...
  it("keeps adjacent trailing reviews in place, including their original spacing", () => {
    ...
    expect(upgraded.text).toBe(
      "Compare [f.ts line](t2-context://v1/review-comment/legacy_review-comment_1)  [f.ts line](t2-context://v1/review-comment/legacy_review-comment_2)",
    );
  });
  ...
  it("keeps a trailing review beside a terminal chip whose payload follows it", () => {
    ...
    expect(upgraded.text).toBe(
      "[Build line 7](t2-context://v1/terminal/legacy_terminal_1) [f.ts line](t2-context://v1/review-comment/legacy_review-comment_1)",
    );
  });
  ...
  it("handles the combined legacy send order: terminal, element, preview, review", () => {
    ...
    expect(upgraded.text).toBe(
      [
        "See [T line 1](t2-context://v1/terminal/legacy_terminal_1)",
        "[f.ts line](t2-context://v1/review-comment/legacy_review-comment_1)",
        "",
        "[<div>](t2-context://v1/element/legacy_element_1) [P](t2-context://v1/preview-annotation/legacy_preview-annotation_1)",
      ].join("\n"),
    );
    expect(upgraded.records.map((record) => record.contextId)).toEqual([
      "legacy_terminal_1",
