...
describe("OtelEnvironment", () => {
  it.effect.each([
    ...
    // T2CODE_OTEL_SDK_DISABLED takes Config.Boolean's values, case-insensitively.
    { name: "t2 1", env: { T2CODE_OTEL_SDK_DISABLED: "1" }, disabled: true, warnings: [T2_OFF] },
    {
      name: "t2 TRUE",
      env: { T2CODE_OTEL_SDK_DISABLED: "TRUE" },
      disabled: true,
      warnings: [T2_OFF],
    },
    { name: "t2 n", env: { T2CODE_OTEL_SDK_DISABLED: "n" }, disabled: false, warnings: [] },
    {
      name: "t2 false overrides spec true",
      env: { T2CODE_OTEL_SDK_DISABLED: "false", OTEL_SDK_DISABLED: "true" },
      disabled: false,
      warnings: [],
    },
    {
      name: "blank t2 falls through",
      env: { T2CODE_OTEL_SDK_DISABLED: "  ", OTEL_SDK_DISABLED: "true" },
      disabled: true,
      warnings: [SPEC_OFF],
    },
    {
      name: "unreadable t2 warns and falls through",
      env: { T2CODE_OTEL_SDK_DISABLED: "maybe", OTEL_SDK_DISABLED: "true" },
      disabled: true,
      warnings: ["T2CODE_OTEL_SDK_DISABLED=maybe is not a yes or a no and was ignored", SPEC_OFF],
    },
    {
      name: "bad spec value still warns when t2 answered",
      env: { T2CODE_OTEL_SDK_DISABLED: "false", OTEL_SDK_DISABLED: "yes" },
      disabled: false,
      warnings: [specIgnored("yes")],
    },
