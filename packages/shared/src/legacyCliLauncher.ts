/**
 * `dist/bin.mjs` of the `@t2code/cli` npm package: the entry point boot-service
 ...
 * executable in the sibling `@t2code/t2-<platform>-<arch>` package.
 *
...
const executable = join(dirname(require.resolve("@t2code/t2-" + process.platform + "-" + process.arch + "/package.json")), executableName);
