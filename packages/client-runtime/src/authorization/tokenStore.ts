...
import { RelayManagedEndpoint } from "@t2code/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@t2code/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@t2code/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
