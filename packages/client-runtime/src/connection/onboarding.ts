import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@t2code/contracts";
import { resolveRemotePairingTarget } from "@t2code/shared/remote";
...
>()("@t2code/client-runtime/connection/onboarding/ConnectionOnboarding") {}
