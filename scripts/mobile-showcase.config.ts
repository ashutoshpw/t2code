...
export function resolveShowcaseAndroidAbi(
  ...
  throw new Error(
    `Unsupported T2_SHOWCASE_ANDROID_ABI '${value}'. Use ${ANDROID_ABIS.join(", ")}.`,
  );
}
  ...
  devices: [
    {
      ...
      simulator: "T2 Showcase iPhone 17 Pro Max",
    ...
    },
    {
      id: "iphone-6.5",
      platform: "ios",
      simulator: "T2 Showcase iPhone 14 Plus",
    ...
    },
    {
      ...
      abi: resolveShowcaseAndroidAbi(process.env.T2_SHOWCASE_ANDROID_ABI),
      appearance: "dark",
      theme: DEFAULT_SHOWCASE_THEME,
      viewport: {
        width: 1080,
