  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new T2 Code prerelease is available for nightly testers."
          : "A new T2 Code latest release is available.",
...
).pipe(Command.withDescription("Post a T2 Code release announcement to Discord."));
