...
const workspaceFiles = [
  ...
  "apps/mobile/modules/t2-markdown-text/package.json",
  "apps/mobile/modules/t2-review-diff/package.json",
  "apps/mobile/modules/t2-terminal/package.json",
  "apps/marketing/package.json",
  "infra/relay/package.json",
  "oxlint-plugin-t2code/package.json",
...
files:
  - url: codes.t2.desktop-9.9.9-smoke.0-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: codes.t2.desktop-9.9.9-smoke.0-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: codes.t2.desktop-9.9.9-smoke.0-arm64.zip
sha512: arm64zip
...
`,
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: codes.t2.desktop-9.9.9-smoke.0-x64.zip
    sha512: x64zip
    size: 132000112
  - url: codes.t2.desktop-9.9.9-smoke.0-x64.dmg
    sha512: x64dmg
    size: 138148807
path: codes.t2.desktop-9.9.9-smoke.0-x64.zip
sha512: x64zip
...
function writeWindowsManifestFixtures(
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: codes.t2.desktop-9.9.9-smoke.0-arm64.exe
    sha512: arm64exe
    size: 126621344
  - url: codes.t2.desktop-9.9.9-smoke.0-arm64.exe.blockmap
    sha512: arm64blockmap
    size: 152344
path: codes.t2.desktop-9.9.9-smoke.0-arm64.exe
sha512: arm64exe
releaseDate: '2026-03-08T10:32:14.587Z'
`,
  );
  ...
  NodeFS.writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: codes.t2.desktop-9.9.9-smoke.0-x64.exe
    sha512: x64exe
    size: 132000112
  - url: codes.t2.desktop-9.9.9-smoke.0-x64.exe.blockmap
    sha512: x64blockmap
    size: 160112
path: codes.t2.desktop-9.9.9-smoke.0-x64.exe
sha512: x64exe
releaseDate: '2026-03-08T10:36:07.540Z'
`,
  );
...
try {
  ...
  assertContains(
    nightlyReleaseMetadata,
    "name=T2 Code Nightly 9.9.10-nightly.20260413.321 (abcdef123456)",
  ...
  assertContains(
    mergedManifest,
    "codes.t2.desktop-9.9.9-smoke.0-arm64.zip",
    "Merged manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedManifest,
    "codes.t2.desktop-9.9.9-smoke.0-x64.zip",
  ...
  assertContains(
    ...
    "codes.t2.desktop-9.9.9-smoke.0-arm64.exe",
    "Merged Windows manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedWindowsManifest,
    "codes.t2.desktop-9.9.9-smoke.0-x64.exe",
