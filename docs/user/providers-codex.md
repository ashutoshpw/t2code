...
Both instances must use the same **CODEX_HOME path**. T2 Code prepares the shared
...
Choose the other account from the thread's model picker. T2 Code offers compatible
