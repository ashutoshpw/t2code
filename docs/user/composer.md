...
also send files to T2 Code through another app's system share sheet.
...
T2 Code remembers your provider, model, and model options for new threads. A
...
Transcription runs on your device. T2 Code deletes the temporary audio after
...
Provider commands must start the message to run. T2 Code commands such as
...
complete T2 Code tells you and leaves the chip for you to remove or replace. A chip whose
...
automatically. HTML previews cannot access your T2 Code session.
