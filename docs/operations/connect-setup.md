...
Deployment and client configuration for T2 Connect. The [architecture note](../internals/t2-connect.md)
explains the trust boundaries; the [relay README](../../infra/relay/README.md#deployment) owns relay
provisioning instructions.

## Public application configuration

T2 Connect is disabled in a fresh clone. To build against the production deployment, copy the
