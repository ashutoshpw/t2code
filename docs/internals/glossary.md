...
Terms whose meaning matters across T2 Code. Architecture and lifecycle constraints belong in the
...
| T2 home        | The base data directory. Runtime state normally lives under its `userdata` directory.             |
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime T2 Code controls, such as Codex or Claude Code.                                            |
...
| Adapter             | The boundary translating a provider's native protocol into T2 Code operations and events.                    |
...
| Context reference    | One occurrence of a record in message text: `[label](t2-context://v1/<kind>/<contextId>)`. Several references can share one record. |
