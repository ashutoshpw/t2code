...
The extension trusts callers that own `t2code.SnapShot` (or the `.Development`
...
inside the extension with coordinates relative to T2's content area. Electron 44's restored-session
