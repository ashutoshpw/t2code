...
Tailscale, SSH, and T2 Connect change how the client reaches that server; they do
...
[T2 Connect trust boundary](./t2-connect.md).
...
connect. This is possible because the desktop renderer is not served by the backend: the `t2code://`
