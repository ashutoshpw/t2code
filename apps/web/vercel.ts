...
const ROUTER_HOST = "app.t2.codes";
const HOSTED_WEB_CHANNEL_COOKIE = "t3code_web_channel";
const LATEST_ORIGIN = "https://latest.app.t2.codes";
const NIGHTLY_ORIGIN = "https://nightly.app.t2.codes";
...
export const config: VercelConfig = {
  buildCommand:
    'vp run --filter @t2code/web build && node ../../scripts/apply-web-brand-assets.ts --channel "${VITE_HOSTED_APP_CHANNEL:-latest}"',
  git: {
