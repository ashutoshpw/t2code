import { ComposerContextRecord, ForwardCompatibleArray } from "@t2code/contracts";
...
export const PROMPT_STASH_STORAGE_KEY = "t2code:prompt-stash:v2";
/**
 ...
 */
const LEGACY_PROMPT_STASH_STORAGE_KEY = "t2code:prompt-stash:v1";
