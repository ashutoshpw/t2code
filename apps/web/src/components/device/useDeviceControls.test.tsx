import { EnvironmentId, type DeviceDetail, type DeviceSummary } from "@t2code/contracts";
import type { DeviceHubAccess } from "@t2code/client-runtime/device/hub-access";
