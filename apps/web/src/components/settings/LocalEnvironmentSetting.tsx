  ...
  return (
    <>
      <SettingsRow
        ...
        description={
          enabled
            ? "Run agents on this computer. Turn off to use T2 Code only with remote environments."
      ...
      >
        <AlertDialogPopup>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {enabled
                ? "T2 Code will restart without running a server on this computer. Any agents and terminals running here will stop, and other devices will no longer be able to connect to this computer. Your projects, history, and remote environments are unaffected."
                : "T2 Code will restart and start running a server on this computer again."}
            </AlertDialogDescription>
          </AlertDialogHeader>
