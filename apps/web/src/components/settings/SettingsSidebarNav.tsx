...
const T2ConnectSidebarSignIn = lazy(() =>
  import("../clerk/T2ConnectSidebarSignIn").then((module) => ({
    default: module.T2ConnectSidebarSignIn,
  })),
);
const T2ConnectSidebarAvatar = lazy(() =>
  import("../clerk/T2ConnectSidebarSignIn").then((module) => ({
    default: module.T2ConnectSidebarAvatar,
  })),
);
