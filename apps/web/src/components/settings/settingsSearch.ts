...
import { STATIC_KEYBINDING_COMMANDS, type KeybindingCommand } from "@t2code/contracts";
...
import { DEFAULT_KEYBINDINGS } from "@t2code/shared/keybindings";
...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    to: "/settings/general",
    searchTerms: ["worktree branch namespace prefix branch name threads"],
  },
  {
  ...
  },
  {
    ...
    searchTerms: [
      "agents cli codex claude cursor grok opencode antigravity fx google sign in sign out install subscription instances authentication api key models configuration binary path config directory endpoint arguments environment variables display name accent color custom favorite hidden auto compact",
    ],
  },
  {
    id: "usage-providers",
  ...
  },
  {
    ...
    title: "Actions",
    to: "/settings/projects",
    searchTerms: ["commands scripts setup run dev server checkout worktree t2.json import"],
  },
  {
    id: "environment-icon",
