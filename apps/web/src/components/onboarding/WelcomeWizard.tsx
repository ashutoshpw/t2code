  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="flex-1">T2 Connect</span>
      ...
      <CollapsiblePanel keepMounted>
        <div className="px-3 pb-3">
          ...
          <CommandBlock command="npx @t2code/cli connect" className="mt-3" />
          <p className="mt-3 text-xs text-muted-foreground">
            Keep T2 Code running. Select the computers you want to set up above.
          </p>
        </div>
      </CollapsiblePanel>
    </Collapsible>
        ...
        <Collapsible>
          ...
          <CollapsiblePanel className="pt-3">
            ...
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start T2 Code first, or run <code className="font-mono">npx @t2code/cli serve</code>.
