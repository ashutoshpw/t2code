...
export function resolveLiveThreadBranchUpdate(input: {
  ...
  gitStatus: VcsStatusResult | null;
  temporaryBranchPrefixes?: ReadonlyArray<string>;
  ...
  if (
    ...
    !isTemporaryWorktreeBranch(input.threadBranch, input.temporaryBranchPrefixes) &&
    isTemporaryWorktreeBranch(input.gitStatus.refName, input.temporaryBranchPrefixes)
  ) {
    return null;
  }
...
export { resolveAutoFeatureBranchName } from "@t2code/shared/git";
