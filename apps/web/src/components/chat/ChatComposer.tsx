...
import type { ComposerContextClipboardFragment, ComposerContextRecord } from "@t2code/contracts";
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const onComposerPaste = (event: React.ClipboardEvent<HTMLElement>) => {
    ...
    // Copied T2 chips need the structured importer to bring their records and files along.
