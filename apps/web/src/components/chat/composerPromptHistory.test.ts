...
describe("recallableComposerPrompt", () => {
  ...
  it("removes canonical references without restoring dangling chips", () => {
    const sent =
      "Look at [Terminal](t2-context://v1/terminal/term-1) please\n    indented  code\n![image](t2-context://v1/image/img-1)";
    expect(recallableComposerPrompt(sent)).toBe("Look at please\n    indented  code");
    expect(recallableComposerPrompt("![image](t2-context://v1/image/img-1)")).toBe("");
  });
