...
describe("pull request checkout commands", () => {
  it.each([
    ...
    [
      ...
      "feature/checkout",
      "maria/t2code",
      "git clone --single-branch --branch feature/checkout https://bitbucket.org/maria/t2code.git t2code-pr-42",
    ],
...
describe("asking about a change rather than working on it", () => {
  ...
  it("builds a neutral composer reference without prescribing an action", () => {
    ...
    expect(context.text).toContain("https://github.com/pingdotgg/t2code/pull/42");
  ...
  it("leaves the composer empty, and everything the agent needs in the chip", () => {
    ...
    expect(chip.text).toContain("https://github.com/pingdotgg/t2code/pull/42");
...
describe("pull request panel context beside a thread", () => {
  ...
  const link = (
    ...
    number,
    url: `https://github.com/pingdotgg/t2code/pull/${number}`,
    source: "manual",
  ...
  const stackThread = {
    ...
    linkedPullRequest: {
      ...
      repository: "pingdotgg/t2code",
      number: 10856,
      url: "https://github.com/pingdotgg/t2code/pull/10856",
    },
  };
  ...
  it("does not let the legacy field decide when the thread holds a link list", () => {
    ...
    const thread = {
      ...
      linkedPullRequest: {
        ...
        repository: "pingdotgg/t2code",
        number: 11105,
        url: "https://github.com/pingdotgg/t2code/pull/11105",
      },
    };
  ...
  it("falls back to the legacy fields only for a thread with no link list", () => {
    const legacy = {
      ...
      repository: "pingdotgg/t2code",
      number: 3,
      url: "https://github.com/pingdotgg/t2code/pull/3",
    };
    expect(
