...
const SETTLED_SHELF_EXPANDED_KEY = "t2code:sidebar:settled-expanded";
const SNOOZED_SHELF_EXPANDED_KEY = "t2code:sidebar:snoozed-expanded";
...
const SidebarThreadRow = memo(function SidebarThreadRow(props: {
  ...
  // Plain clicks open T2; individual PR links also support opening the host in a new tab.
...
export default function Sidebar() {
  ...
  // Threads on non-primary environments (T2 Connect, hosted) resolve their
