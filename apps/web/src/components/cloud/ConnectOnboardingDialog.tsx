...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@t2code/contracts";
...
/**
 * Post-sign-in onboarding wizard for T2 Connect. Opens on every in-session
 ...
 * account's T2 Connect environments so every device can be connected right
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through T2 Connect."
