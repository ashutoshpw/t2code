import type { DiscoveredLocalServer, ScopedThreadRef } from "@t2code/contracts";
import { mapAtomCommandResult, type AtomCommandResult } from "@t2code/client-runtime/state/runtime";
