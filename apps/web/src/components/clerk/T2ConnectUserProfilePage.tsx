...
export function T2ConnectEnvironmentRow(props: {
...
export function T2ConnectUserProfilePage() {
          ...
          <Empty className="min-h-64 gap-4 border-t px-6 py-10 md:p-10">
            ...
            <EmptyHeader>
              <EmptyTitle className="text-[1.0625rem] leading-6">
                No T2 Connect environments
              </EmptyTitle>
              <EmptyDescription className="text-[0.8125rem] leading-[1.125rem]">
                Link an environment from its local Settings to make it available through T2 Connect.
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
        )}
