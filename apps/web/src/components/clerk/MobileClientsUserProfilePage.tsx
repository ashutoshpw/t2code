import type { RelayClientDeviceRecord } from "@t2code/contracts/relay";
  ...
  return (
    <Empty size="compact">
      ...
      <EmptyHeader>
        ...
        <EmptyDescription>
          Sign in to T2 Code on your iPhone to register it for push notifications and Live
          Activities.
        </EmptyDescription>
      </EmptyHeader>
    </Empty>
...
export function MobileClientsUserProfilePage() {
  ...
  return (
    <ClerkUserProfilePage
      ...
      description="Devices registered to receive T2 Connect activity from your environments."
      action={
        <ClerkUserProfileRefreshButton
