...
import type { PullRequestMergeMethod } from "@t2code/contracts";
import { create } from "zustand";
import { normalizeProjectPathForComparison } from "./lib/projectPaths";

export const PERSISTED_STATE_KEY = "t2code:ui-state:v1";
// Version 1 stored card visibility, not folder expansion.
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 2;
const LEGACY_PERSISTED_STATE_KEYS = [
  "t2code:renderer-state:v8",
  "t2code:renderer-state:v7",
  "t2code:renderer-state:v6",
  "t2code:renderer-state:v5",
  "t2code:renderer-state:v4",
  "t2code:renderer-state:v3",
