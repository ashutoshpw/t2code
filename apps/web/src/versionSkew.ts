import type { EnvironmentId, ServerConfig, ServerSelfUpdateCapability } from "@t2code/contracts";
...
const VERSION_MISMATCH_DISMISSALS_STORAGE_KEY = "t2code:version-mismatch-dismissals:v1";
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same T2 Code version.",
  };
}
...
export function manualServerUpdateCommand(targetVersion: string): string {
  return `npx @t2code/cli@${targetVersion}`;
}
