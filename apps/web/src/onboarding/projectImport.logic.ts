import { findProjectByPath } from "@t2code/client-runtime/state/projects";
import type { AgentSessionProjectCandidate, EnvironmentId, ProjectId } from "@t2code/contracts";
