...
const NAME = "org.gnome.Shell.Extensions.T2SnapShot";
const PATH = "/org/gnome/Shell/Extensions/T2SnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`T2 capture preview unavailable: ${error.message}`);
    }
  }
...
export default class T2SnapShotExtension extends Extension {
  enable() {
