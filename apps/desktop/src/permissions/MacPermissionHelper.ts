...
<header>↑ Drag T2 Code into the list above</header>
<button id="app" draggable="true" aria-label="Drag T2 Code to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">T2 Code</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged T2 Code icon is missing.");
