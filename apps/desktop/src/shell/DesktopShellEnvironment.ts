...
>()("@t2code/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__T2CODE_ENV_${name}_START__`;
const endMarker = (name: string) => `__T2CODE_ENV_${name}_END__`;
