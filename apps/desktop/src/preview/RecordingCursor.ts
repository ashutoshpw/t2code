...
export function installRecordingCursor(
  ...
  style.textContent =
    "html, html * { cursor: none !important; } @media (prefers-reduced-motion: reduce) { [data-t2code-recording-agent-cursor] { transition: none !important; } }";
  const cursor = document.createElement("div");
  cursor.setAttribute("aria-hidden", "true");
  cursor.setAttribute("data-t2code-recording-cursor", "");
  ...
  agentCursor.setAttribute("data-t2code-recording-agent-cursor", "");
