 ...
 * into a T2 Code browser profile's Electron partition.
 *
...
import { BrowserImportFailureReason } from "@t2code/contracts";
...
import { HostProcessExecutablePath, HostProcessPlatform } from "@t2code/shared/hostProcess";
...
>()("@t2code/desktop/preview/BrowserImport/BrowserImport") {}
