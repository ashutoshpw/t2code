...
const PREVIEW_PARTITION_PREFIX = "persist:t2code-preview-";
/**
 ...
 */
const PREVIEW_EPHEMERAL_PARTITION_PREFIX = "t2code-preview-ephemeral-";
...
>()("@t2code/desktop/preview/BrowserSession") {}
