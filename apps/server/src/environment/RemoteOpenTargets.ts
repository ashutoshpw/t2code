 ...
 */
import { type RemoteOpenTarget } from "@t2code/contracts";
import { HostProcessHostname } from "@t2code/shared/hostProcess";
import * as NetService from "@t2code/shared/Net";
import { readTailscaleStatus } from "@t2code/tailscale";
