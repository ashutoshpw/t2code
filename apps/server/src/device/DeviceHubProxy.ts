 ...
 * environment session with read scope (operate scope for input and tuning). Reusing the T2
 * origin is also what makes remote connections work unchanged — Tailscale and
 * T2 Connect already carry `/api/*` and WebSocket upgrades for the app itself.
 *
