import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@t2code/contracts";
...
const T2_CODE_OAUTH_REFERRER = "t3code";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: T2_CODE_OAUTH_REFERRER,
    },
  };
}
