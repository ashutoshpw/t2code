...
import { ProviderDriverKind, ProviderInstanceId, type CursorSettings } from "@t2code/contracts";
...
const cursorAcpDiscoveryFailedMessage = [
  ...
  "Cursor CLI setup may be incomplete; install or enable the Cursor CLI, restart T2 Code, and try again.",
...
const cursorCliCommandMissingMessage = [
  ...
  `Install or enable the Cursor CLI, make sure \`${missingCursorBinaryPath}\` is on PATH, then restart T2 Code.`,
  "See https://cursor.com/docs/cli/installation.",
].join(" ");
