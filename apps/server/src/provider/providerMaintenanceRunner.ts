...
>()("@t2code/cli/provider/providerMaintenanceRunner") {}
                ...
                makeUpdateState({
                  ...
                  message:
                    targetVersion !== undefined
                      ...
                      : "The latest provider version is incompatible with this T2 Code release. Review provider settings.",
                }),
              );
            }
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but T2 Code could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but T2 Code still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
