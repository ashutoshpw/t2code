...
import { nodeRuntimeUnavailableMessage } from "@t2code/shared/nodeRuntime";
...
export function agentDeviceQuickStart(
  ...
  return [
    ...
    "For remote hosts, arrange builds, app installation, and any Metro reverse forwarding yourself. T2 provides discovery, streaming, and control only.",
