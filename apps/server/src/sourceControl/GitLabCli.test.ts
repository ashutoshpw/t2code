...
import { VcsProcessExitError } from "@t2code/contracts";
  ...
  it.effect("parses merge request view output", () =>
    Effect.gen(function* () {
        ...
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              ...
              web_url: "https://gitlab.com/pingdotgg/t2code/-/merge_requests/42",
              target_branch: "main",
              ...
              source_project: {
                path_with_namespace: "octocat/t2code",
              },
            }),
          ),
        ),
      ...
      assert.deepStrictEqual(result, {
        number: 42,
        title: "Add MR thread creation",
        url: "https://gitlab.com/pingdotgg/t2code/-/merge_requests/42",
        baseRefName: "main",
            ...
            JSON.stringify([
              {
                iid: 0,
                title: "invalid",
                web_url: "https://gitlab.com/pingdotgg/t2code/-/merge_requests/0",
                target_branch: "main",
              ...
              },
              {
                iid: 43,
                title: "  Valid MR  ",
                web_url: " https://gitlab.com/pingdotgg/t2code/-/merge_requests/43 ",
                target_branch: " main ",
      ...
      assert.deepStrictEqual(result, [
        {
          number: 43,
          title: "Valid MR",
          url: "https://gitlab.com/pingdotgg/t2code/-/merge_requests/43",
          baseRefName: "main",
  ...
  it.effect("reads repository clone URLs", () =>
    Effect.gen(function* () {
      mockedRun.mockReturnValueOnce(
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              path_with_namespace: "octocat/t2code",
              web_url: "https://gitlab.com/octocat/t2code",
              http_url_to_repo: "https://gitlab.com/octocat/t2code.git",
              ssh_url_to_repo: "git@gitlab.com:octocat/t2code.git",
            }),
          ),
        ),
      );
      ...
      assert.deepStrictEqual(result, {
        ...
        url: "https://gitlab.com/octocat/t2code",
        sshUrl: "git@gitlab.com:octocat/t2code.git",
      });
    }),
  );
