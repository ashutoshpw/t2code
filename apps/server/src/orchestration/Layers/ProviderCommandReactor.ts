...
const make = Effect.gen(function* () {
  ...
  const maybeGenerateAndRenameWorktreeBranchForFirstTurn = Effect.fn(
    ...
    yield* Effect.gen(function* () {
      ...
      const branchPrefix = sanitizeWorktreeBranchPrefix(settings.worktreeBranchPrefix);
      if (!isTemporaryWorktreeBranch(oldBranch, temporaryWorktreeBranchPrefixes(branchPrefix))) {
        return;
      }
