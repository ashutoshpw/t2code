...
import type { OrchestrationThreadActivity } from "@t2code/contracts";
...
describe("projectActivityPayload", () => {
  ...
  it.each([
    ...
    { tool: "t2-code_preview_status", state: { output: '{"url":"https://example.com/"}' } },
    {
      toolName: "mcp__t2_code__preview_snapshot",
      result: {
        content: [
    ...
    ...[
      ...
      toolName: `mcp__t2_code__preview_${action}`,
      result: { content: '{"toolIcon":{"_tag":"website","pageUrl":"https://example.com/"}}' },
    })),
  ...
  it.each([
    ...
    {
      toolName: "mcp__t2-code__preview_evaluate",
      result: { content: '{"url":"https://example.com/"}' },
    },
    {
      toolName: "mcp__t2-code__preview_open",
      result: { isError: true, content: '{"url":"https://example.com/"}' },
    },
    { toolName: "mcp__t2-code__preview_open", result: { content: "malformed JSON" } },
    { toolName: "mcp__t2-code__preview_open", result: { content: '{"url":"about:blank"}' } },
