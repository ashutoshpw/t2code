/**
 * `t2code triage` - hand a misbehaving install to the user's own coding agent.
 *
...
export const triageCommand = Command.make("triage", {
  ...
  Command.withDescription(
    "Investigate a T2 Code problem on this machine with claude or codex, and help file a good issue.",
  ),
