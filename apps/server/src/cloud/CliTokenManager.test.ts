...
const TEST_ENV = {
  T2CODE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  T2CODE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  T2CODE_HOSTED_APP_URL: "https://hosted.example.test",
};
