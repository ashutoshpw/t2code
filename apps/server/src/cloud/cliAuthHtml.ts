...
declare const __T2CODE_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __T2CODE_BUILD_CHANNEL__ === "undefined" ? "dev" : __T2CODE_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "T2 Code (Dev)",
  nightly: "T2 Code (Nightly)",
  latest: "T2 Code",
...
<html lang="en">
  <head>
    ...
    <title>T2 Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up T2 Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
