  ...
  it.each([
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "t2-code", tool: "preview_navigate" },
      status: "inProgress",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "t2-code", tool: "task_status" },
      status: "inProgress",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "mcp__t2-code__preview_snapshot",
      item: undefined,
      status: "inProgress",
    ...
    },
    {
      ...
      label: "mcp__t2-code__task_status",
      title: undefined,
      item: undefined,
      status: "inProgress",
      displayName: "Getting delegated task status",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "t2-code", tool: "preview_click" },
      status: undefined,
          ...
          makeActivity({
            ...
            payload: {
              ...
              ...(index < commandCount
                ...
                : {
                    itemType: "mcp_tool_call",
                    data: { item: { server: "t2-code", tool: "preview_click" } },
                  }),
            },
          }),
        ),
