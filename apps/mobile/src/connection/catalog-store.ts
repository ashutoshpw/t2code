...
import { ConnectionTransientError } from "@t2code/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "t2code.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "t2code.connections";
