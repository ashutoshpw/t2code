...
import { reportAtomCommandResult, settlePromise } from "@t2code/client-runtime/state/runtime";
...
/**
 * Post-sign-in onboarding sheet for T2 Connect. Mobile never publishes
 * environments itself — it consumes ones published elsewhere — so this simply
 * surfaces the account's T2 Connect environments right after sign-in so every
        ...
        {isSignedIn ? (
          ...
          <View collapsable={false} className="rounded-[24px] bg-card p-5">
            <Text className="text-sm leading-normal text-foreground-muted">
              Sign in to your T3 account to set up T2 Connect.
            </Text>
          </View>
        )}
