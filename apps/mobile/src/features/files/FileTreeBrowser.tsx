    ...
    >
      ...
      <Text
        className={cn(
          ...
          props.selected
            ? "font-t2-bold text-foreground"
            : node.ignored
              ? "font-t2-medium text-foreground-tertiary"
              : "font-t2-medium text-foreground-secondary",
        )}
        numberOfLines={1}
      >
        {node.name}
      ...
      {node.kind === "directory" && props.loaded ? (
        <Text className="text-2xs font-t2-medium text-foreground-tertiary">
    ...
    <FlatList
      ...
      ListEmptyComponent={
        <View className="px-4 py-5">
          {props.error && props.entries.length === 0 ? (
            <>
              <Text className="text-sm font-t2-bold text-foreground">Files unavailable</Text>
              <Text
              ...
              >
                <Text className="text-sm font-t2-medium text-foreground">Try again</Text>
              </Pressable>
            </>
          ) : props.isPending ? (
            ...
            <>
              <Text className="text-sm font-t2-bold text-foreground">No files found</Text>
