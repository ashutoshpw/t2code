...
import { MarkdownTextPrimitive } from "@t2code/mobile-markdown-text/primitive";
  ...
  if (props.status === "error") {
    return (
      <View className="border-b border-border bg-card px-4 py-2">
        <Text className="text-2xs font-t2-medium uppercase text-foreground-muted">Plain text</Text>
      </View>
    );
  }
  return null;
