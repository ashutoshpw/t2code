 ...
 *
 * Enabled when `__DEV__` is true, or set `globalThis.__T2_TERMINAL_DEBUG__ = true` in a JS
...
export function isTerminalDebugEnabled(): boolean {
  return (
    ...
    (typeof globalThis !== "undefined" &&
      (globalThis as { __T2_TERMINAL_DEBUG__?: boolean }).__T2_TERMINAL_DEBUG__ === true)
  );
}
