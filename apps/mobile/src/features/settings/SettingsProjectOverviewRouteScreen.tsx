    ...
    <>
      <View className="flex-row items-center gap-4 px-2">
        ...
        <View className="min-w-0 flex-1">
          <Text className="text-xl font-t2-semibold text-foreground" numberOfLines={2}>
            {displayName}
          </Text>
      ...
      <SettingsSection title="Project">
        <View className="gap-3 p-4">
          <Text className="text-sm font-t2-medium text-foreground-muted">Name</Text>
          <View className="flex-row items-center gap-3">
            ...
            {canSave ? (
              ...
              >
                <Text className="text-sm font-t2-medium text-foreground">Save</Text>
              </Pressable>
            ) : null}
          </View>
        </View>
