...
import { type EnvironmentMachineKind, resolveEnvironmentMachineKind } from "@t2code/contracts";
...
function CacheEnvironmentRow(props: {
  ...
  return (
    ...
    >
      ...
      >
        <Text className="font-t2-medium tabular-nums text-danger-foreground" numberOfLines={1}>
