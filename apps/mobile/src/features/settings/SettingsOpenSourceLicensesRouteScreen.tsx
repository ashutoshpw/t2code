    ...
    >
      <View className="flex-row items-start gap-3">
        <View className="min-w-0 flex-1 gap-1">
          <Text className="text-base font-t2-medium text-foreground" numberOfLines={2}>
            {props.entry.name}
          </Text>
    ...
    <SettingsScreen title="License notice">
      ...
      >
        <View className="gap-2 px-1">
          <Text className="text-2xl font-t2-bold text-foreground">{entry.name}</Text>
          <Text className="text-base leading-normal text-foreground-muted">
          ...
          {sourceUrl ? (
            ...
            >
              <Text className="font-t2-medium text-primary-text">Project source</Text>
              <SymbolView
                name="arrow.up.right"
                size={16}
