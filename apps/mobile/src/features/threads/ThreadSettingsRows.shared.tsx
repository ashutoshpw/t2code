      ...
      >
        ...
        <View className="min-w-0 flex-1">
          <View className="flex-row items-center gap-2">
            <Text
              className="min-w-0 shrink text-base font-t2-medium text-foreground"
            ...
            {props.option.isDefault ? (
              <View className="rounded-md bg-subtle-strong px-1.5 py-0.5">
                <Text className="text-3xs font-t2-bold text-foreground-muted">Default</Text>
              </View>
            ) : null}
            {props.option.isLegacy ? (
              <View className="rounded-md bg-subtle px-1.5 py-0.5">
                <Text className="text-3xs font-t2-bold text-foreground-muted">Legacy</Text>
              </View>
            ) : null}
  ...
  return (
    ...
    >
      ...
      <View className="min-w-0 flex-1 gap-0.5">
        <Text className="text-base font-t2-medium text-foreground">{props.label}</Text>
        {props.description ? (
