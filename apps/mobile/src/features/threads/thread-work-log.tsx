...
import type { EnvironmentId, ToolActivityIcon } from "@t2code/contracts";
...
type WorkContentIcon = AppSymbolName | "browser" | "device" | "t2-code" | "pull-request";
      ...
      >
        <View className="min-h-8 flex-row items-center gap-1.5">
            ...
            <>
              ...
              <Text
                className={cn(
                  ...
                  iconIsDestructive && "font-t2-medium text-adaptive-rose-600-400",
                )}
          ...
          <View className="shrink-0 flex-row items-center gap-px">
            {props.copied ? (
              <Text className="pr-1 font-t2-medium text-3xs text-adaptive-emerald-600-400">
                Copied
              </Text>
            ) : null}
...
export function ThreadWorkGroupToggle(props: {
  ...
  readonly summaryToolIcon?: "browser" | "device" | "t2-code" | "pull-request" | "brain";
  readonly themeAppearance: "light" | "dark";
  readonly toolSurface?: import("@t2code/contracts").ToolActivitySurface;
  readonly toolIcon?: ToolActivityIcon;
