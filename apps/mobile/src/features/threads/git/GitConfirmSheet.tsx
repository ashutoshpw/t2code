import { resolveDefaultBranchActionDialogCopy } from "@t2code/client-runtime/state/vcs";
import { resolveAutoFeatureBranchName } from "@t2code/shared/git";
        ...
        >
          ...
          >
            ...
            <Text
              className={
                Platform.OS === "android"
                  ? "text-xl font-t2-medium"
                  : "text-center text-3xl font-t2-bold"
              }
            >
