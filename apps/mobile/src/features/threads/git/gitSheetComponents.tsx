...
export function SheetActionButton(props: {
  ...
  return (
    ...
    >
      ...
      <Text
        className={cn(
          "text-xs font-t2-bold tracking-[0.9px] uppercase",
          tone === "primary"
...
export function MetaCard(props: { readonly label: string; readonly value: string }) {
  return (
    ...
    >
      <Text className="text-foreground-muted text-2xs font-t2-bold tracking-[0.9px] uppercase">
        {props.label}
      </Text>
        ...
        <Text
          className={
            Platform.OS === "android"
              ...
              : "text-foreground text-base font-t2-bold"
          }
        >
          {props.title}
        </Text>
