import { sanitizeFeatureBranchName } from "@t2code/shared/git";
      ...
      <MaterialScreenContent fitToContents>
        ...
        >
          <View className="bg-card android:gap-3 android:rounded-[20px] android:p-4 ios:gap-2 ios:rounded-[18px] ios:border ios:border-border ios:px-4 ios:py-4">
            <Text className="android:text-foreground android:text-base android:font-t2-medium ios:text-foreground-secondary ios:text-2xs ios:font-t2-bold ios:tracking-[1px] ios:uppercase">
              New branch
            </Text>
            <TextInput
              value={newBranchName}
          ...
          <View className="gap-2">
            <Text className="text-foreground-secondary android:px-4 android:pb-1 android:pt-3 android:text-sm android:font-t2-medium ios:text-2xs ios:font-t2-bold ios:tracking-[1px] ios:uppercase">
              Existing branches
            </Text>
            {branchesLoading ? (
