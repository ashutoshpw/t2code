        ...
        >
          ...
          >
            <Text
              className={
                Platform.OS === "android"
                  ? "text-foreground text-base font-t2-medium"
                  : "text-foreground-secondary text-2xs font-t2-bold tracking-[1px] uppercase"
              }
            >
              New branch
            </Text>
          ...
          <View className="gap-2">
            <Text
              className={
                Platform.OS === "android"
                  ? "px-4 pb-1 pt-3 text-foreground-secondary text-sm font-t2-medium"
                  : "text-foreground-secondary text-2xs font-t2-bold tracking-[1px] uppercase"
              }
            >
              Existing branches
                ...
                >
                  ...
                  <Text
                    className={cn(
                      ...
                      Platform.OS === "android" ? "font-t2-medium" : "font-t2-bold",
                    )}
                  >
                    {branch.name}
                  </Text>
