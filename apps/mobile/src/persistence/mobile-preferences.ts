...
import type { ProviderInstanceId, SidebarProjectGroupingMode } from "@t2code/contracts";
...
const PREFERENCES_KEY = "t2code.preferences";
const PREFERENCES_FALLBACK_KEY = "t2code.preferences.fallback";
...
>()("@t2code/mobile/persistence/MobilePreferencesStore") {}
