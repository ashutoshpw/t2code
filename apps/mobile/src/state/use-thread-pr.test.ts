import { ProjectId, type ThreadPullRequestLink, type VcsStatusResult } from "@t2code/contracts";
...
const pullRequest: NonNullable<VcsStatusResult["pr"]> = {
  ...
  url: "https://github.com/t2tools/t2code/pull/3774",
  baseRef: "main",
...
describe("resolveThreadPrSource compatibility", () => {
  const legacyRef = {
    ...
    repository: "t2tools/t2code",
    number: 1,
    url: "https://github.com/t2tools/t2code/pull/1",
  };
  const branchRef = { ...legacyRef, number: 2, url: "https://github.com/t2tools/t2code/pull/2" };
