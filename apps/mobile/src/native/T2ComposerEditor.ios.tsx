import { PASTED_TEXT_ATTACHMENT_THRESHOLD_BYTES } from "@t2code/client-runtime/text-paste";
import { PROVIDER_SEND_TURN_MAX_INPUT_CHARS } from "@t2code/contracts";
import { collectComposerInlineTokens } from "@t2code/shared/composerInlineTokens";
...
} from "@t2code/mobile-markdown-text/markdown";
import { resolveMarkdownFileIcon } from "@t2code/mobile-markdown-text/links";
...
import type { ComposerEditorProps, ComposerEditorSelection } from "./T2ComposerEditor.types";

const NATIVE_MODULE_NAME = "T2ComposerEditor";
