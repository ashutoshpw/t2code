...
import { decodeComposerContextFragment } from "@t2code/shared/composerContextClipboard";
import {
  findNodeHandle,
  Image,
  Linking,
...
} from "./T2MarkdownTextSelectionModule";
...
export function NativeMarkdownSelectableText(props: {
  ...
  // T2MarkdownText only rebuilds its attributed string during native layout. A
