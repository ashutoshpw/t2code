...
import { setMarkdownSelectionHandleColor } from "./T2MarkdownTextSelectionModule";
import T2MarkdownTextRunNativeComponent from "./T2MarkdownTextRunNativeComponent";
import T2MarkdownTextNativeComponent from "./T2MarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <T2MarkdownTextRunNativeComponent
