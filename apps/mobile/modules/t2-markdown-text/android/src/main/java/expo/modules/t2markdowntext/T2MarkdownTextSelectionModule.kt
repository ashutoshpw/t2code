package expo.modules.t2markdowntext
...
class T2MarkdownTextSelectionModule : Module() {
  ...
  override fun definition() = ModuleDefinition {
    ...
    Function("renderContextChip") { payloadJson: String ->
      ...
      val chip = T2ContextChip(
        content = T2ContextChip.Content(
        ...
        colors = T2ContextChip.Colors(
          accent = T2ContextChip.color(payload.optString("accent"), Color.GRAY),
          foreground = T2ContextChip.color(payload.optString("foreground"), Color.BLACK),
          border = T2ContextChip.color(payload.optString("border"), Color.GRAY)
        ),
