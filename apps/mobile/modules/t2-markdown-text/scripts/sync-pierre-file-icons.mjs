...
const customSprite = webIconSource.match(/const T2_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error("Could not read the T2 Pierre icon sprite from apps/web/src/pierre-icons.ts");
}
