...
static NSDictionary *T2ContextChipPayload(NSString *uri)
{
...
static UIColor *T2ContextChipColor(NSString *hex)
{
  unsigned int rgb = 0;
...
static UIColor *T2ContextChipBlend(UIColor *accent, UIColor *base, CGFloat weight)
{
...
static UIImage *T2ContextChipVectorIcon(NSString *symbol, CGFloat size, UIColor *color)
{
...
static inline CGRect T2ContextChipBounds(UIFont *font, CGSize size)
{
...
static inline NSAttributedString *T2MarkdownTextAttachmentString(
...
static UIFont *T2ContextChipFont(NSDictionary *payload)
{
...
static inline CGSize T2ContextChipSize(NSDictionary *payload, CGFloat maximumWidth)
{
  UIFont *font = T2ContextChipFont(payload);
...
static inline UIImage *T2ContextChipImage(NSDictionary *payload, CGSize size, UIImage *fileIcon)
{
  ...
  UIColor *accent = T2ContextChipColor(payload[@"accent"]);
  UIColor *foreground = T2ContextChipBlend(accent, T2ContextChipColor(payload[@"foreground"]), 0.22);
  UIColor *border = T2ContextChipBlend(accent, T2ContextChipColor(payload[@"border"]), 0.34);
  ...
  UIImage *image = [renderer imageWithActions:^(UIGraphicsImageRendererContext *context) {
    ...
    UIImage *icon = fileIcon
        ?: T2ContextChipVectorIcon(payload[@"symbol"], iconSize, foreground)
