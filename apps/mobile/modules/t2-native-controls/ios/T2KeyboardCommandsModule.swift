...
public final class T2KeyboardCommandsModule: Module {
  public func definition() -> ModuleDefinition {
    Name("T2KeyboardCommands")

    View(T2KeyboardCommandsView.self) {
      Prop("enabledCommands") { (view: T2KeyboardCommandsView, commands: [String]) in
...
public final class T2KeyboardCommandsView: ExpoView {
