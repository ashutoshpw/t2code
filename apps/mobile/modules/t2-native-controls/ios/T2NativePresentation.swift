...
final class T2PresentationSources {
  private class Entry {
...
final class T2PresentationSourceView: ExpoView {
  weak var sources: T2PresentationSources?
  var identifier = "" {
    didSet {
...
final class T2ContextSheetSizeView: ExpoView {
