...
final class T2NativeFilePresentation: NSObject, QLPreviewControllerDataSource,
  QLPreviewControllerDelegate, UIAdaptivePresentationControllerDelegate {
  let identifier: String
  private var controller: UIViewController?
  private let completion: (Error?) -> Void
  private weak var sources: T2PresentationSources?
  ...
  init(identifier: String, sources: T2PresentationSources, sourceIdentifier: String, completion: @escaping (Error?) -> Void) {
