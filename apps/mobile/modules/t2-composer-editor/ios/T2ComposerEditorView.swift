...
private final class ComposerTextView: UITextView {
  ...
  override func copy(_ sender: Any?) {
    ...
    T2ComposerClipboard.write(text: serializedText(in: selectedRange), fragment: clipboardFragment)
  }
...
public final class T2ComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate, UIGestureRecognizerDelegate {
  ...
  private func renderChip(
    ...
    // Kept in step with `T2ContextChipVectorIcon` in the markdown module: a chip drawn here and
