...
const rule = createOxlintRuleHarness("t2code/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("t2code/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · T2 Code";`);
