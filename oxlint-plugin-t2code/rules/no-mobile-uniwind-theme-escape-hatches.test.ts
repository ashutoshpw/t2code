...
const guardedMobileFile = createOxlintRuleHarness("t2code/no-mobile-uniwind-theme-escape-hatches", {
  filename: "apps/mobile/src/features/settings/NewThemeSurface.tsx",
});
const reviewedInteropFile = createOxlintRuleHarness(
  "t2code/no-mobile-uniwind-theme-escape-hatches",
  {
...
describe("t2code/no-mobile-uniwind-theme-escape-hatches", () => {
