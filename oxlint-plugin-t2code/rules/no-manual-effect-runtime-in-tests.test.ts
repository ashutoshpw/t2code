...
const rule = createOxlintRuleHarness("t2code/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("t2code/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("t2code/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("t2code/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("t2code/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
