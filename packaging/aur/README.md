...
This directory maintains the [`t2code-bin`](https://aur.archlinux.org/packages/t2code-bin) and
[`t2code-nightly-bin`](https://aur.archlinux.org/packages/t2code-nightly-bin) packages. Both
